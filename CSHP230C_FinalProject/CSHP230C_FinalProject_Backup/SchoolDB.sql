...
(UserName, UserEmail, UserPassword, USerIsAdmin)
	Values
		('Joshua', 'joshua001@learningcenter.com', 'password12345', 1),
		('John', 'john001@learningcenter.com', 'password54321', 0),
		('Jane', 'jane001@learningcenter.com', '12345password', 0)
;
Go
